...
<div class="wrapper" id="error-404-wrapper">
	...
	<div class="<?php echo esc_attr( $container ); ?>" id="content" tabindex="-1">
		...
		<div class="row-404 row">
			<div class="col-md-6">
				<?php the_field('left_column_404', 'option'); ?>
			</div>
			<div style="margin-top: 50px;" class="col-md-6">
				<img src="<?php echo get_field('right_column_404', 'option'); ?>" alt="">
			</div>

			<?php /*?><div class="col-md-12 content-area" id="primary">
