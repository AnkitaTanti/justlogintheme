<?php
/**
 * Template Name: Knowledge Hub Page
 *
...
<div class="wrapper" id="page-wrapper">
	...
	<?php if($_GET["lang"]=='zh-hant') { ?>
    	<div><?php echo do_shortcode('[searchandfilter id="2577"]'); ?></div>
    	<div id="blog-search"><?php echo do_shortcode('[searchandfilter id="2577" show="results"]'); ?></div>
  <?php } else { ?>
			<div><?php echo do_shortcode('[searchandfilter id="862"]'); ?></div>
			<div id="blog-search"><?php echo do_shortcode('[searchandfilter id="862" show="results"]'); ?></div>
  <?php } ?>
